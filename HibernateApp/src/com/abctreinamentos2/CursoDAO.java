...
public class CursoHome {
	...
	public Curso findById(java.math.BigDecimal id) {
		...
		try {
			Curso instance = (Curso) sessionFactory.getCurrentSession().get("com.abctreinamentos2.Curso", id);
			if (instance == null) {
	...
	public List findByExample(Curso instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.abctreinamentos2.Curso")
