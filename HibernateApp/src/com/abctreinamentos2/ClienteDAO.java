...
public class ClienteHome {
	...
	public Cliente findById(java.math.BigDecimal id) {
		log.debug("getting Cliente instance with id: " + id);
		try {
			Cliente instance = (Cliente) sessionFactory.getCurrentSession().get("com.abctreinamentos2.Cliente", id);
			if (instance == null) {
	...
	public List findByExample(Cliente instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.abctreinamentos2.Cliente")
